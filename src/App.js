...
const PlayerMerge = Load(() => import('./admin/pages/PlayerMerge'))
        ...
        <MuiPickersUtilsProvider utils={DayjsUtils}>
          ...
          <ErrorBoundary>
            <Switch>
              ...
              />
              <Route
                path={ROUTES.ALLPLAYERS19}
                exact
                component={AllPlayers19}
              />
              <Route
              ...
              />
              <Route
                path={ROUTES.ALLPLAYERS21}
                exact
                component={AllPlayers21}
              />
              <Route
              ...
              <Route path={ROUTES.PLAYER_MERGE} exact component={PlayerMerge} />
            </Switch>
          </ErrorBoundary>
